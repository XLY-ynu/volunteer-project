...
export const fetchContent = (page = 1, size = 10, categoryId?: number, published?: boolean, keyword?: string, sortOrder?: string) =>
  http.get('/content', { params: { page, size, categoryId, published, keyword, sortOrder } });
