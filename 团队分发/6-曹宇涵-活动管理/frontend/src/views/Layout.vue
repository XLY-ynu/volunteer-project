...
<template>
  <el-container style="min-height: 100vh">
    <el-aside width="220px" class="aside">
      <div class="logo"><span class="logo-icon">📅</span><span class="logo-text">活动管理</span></div>
      <el-menu :default-active="active" class="menu" @select="onSelect">
        <el-menu-item index="/activities"><el-icon><Calendar /></el-icon><span>活动管理</span></el-menu-item>
        <el-menu-item index="/help-requests"><el-icon><ChatDotRound /></el-icon><span>求助处理</span></el-menu-item>
      </el-menu>
    </el-aside>
    <el-container>
...
<style scoped>
.aside { background: linear-gradient(180deg, #67c23a 0%, #409eff 100%); color: #fff; }
...
.avatar { background: linear-gradient(135deg, #67c23a, #409eff); color: #fff; font-weight: 600; }
