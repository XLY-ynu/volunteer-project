...
-- 7. 示例志愿活动
-- ============================================
INSERT INTO activity (title, description, location, start_time, end_time, capacity, checkin_code, created_at, updated_at) VALUES
('情暖三湘·志愿同行', '聚焦老年人尤其是空巢、独居老人的急难愁盼问题，开展慰问陪护、清洁卫生等志愿服务。', 
'敬老院、养老院等', '2026-01-15 09:00:00', '2026-01-15 17:00:00', 50, '382388', NOW(), NOW()),
('环保志愿行动', '组织志愿者参与城市环境清洁、垃圾分类宣传等活动。', 
